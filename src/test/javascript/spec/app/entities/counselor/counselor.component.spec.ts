...
import { CounselorComponent } from 'app/entities/counselor/counselor.component';
...
describe('Component Tests', () => {
  describe('Counselor Management Component', () => {
    let comp: CounselorComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CounselorComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.counselors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });

...
describe('Service Tests', () => {
  describe('Library Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Library(0, 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', async () => {
        const returnedFromService = Object.assign(
          {
            creationTime: currentDate.format(DATE_FORMAT)
          },
          elemDefault
        );
        service
      ...
      it('should return a list of Library', async () => {
        const returnedFromService = Object.assign(
          {
            name: 'BBBBBB',
            creationTime: currentDate.format(DATE_FORMAT)

...
public class SocialServiceIntTest {
    ...
    public void setup() {
        ...
        socialService = new SocialService(mockUsersConnectionRepository, authorityRepository,
            userRepository, passwordEncoder, mockMailService);
    }

    @Test
    public void testDeleteUserSocialConnection() throws Exception {
        // Setup
        Connection<?> connection = createConnection("09193446824",
            "mail@mail.com",
            "John",
            "John",
            "IMAGE_URL",
            "facebook");
        socialService.createSocialUser(connection, "fa");
        ...
        // Exercise
        socialService.deleteUserSocialConnection("09193446824");

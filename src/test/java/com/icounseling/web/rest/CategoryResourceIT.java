...
public class CategoryResourceIT {
    ...
    private static final CategoryType DEFAULT_CATEGORY_TYPE = CategoryType.ROMANCE;
    private static final CategoryType UPDATED_CATEGORY_TYPE = CategoryType.ARTS_PHOTOGRAPHY;
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getImages()).isEqualTo(DEFAULT_IMAGES);
        assertThat(testCategory.getImagesContentType()).isEqualTo(DEFAULT_IMAGES_CONTENT_TYPE);
    ...
    public void updateCategory() throws Exception {
        ...
        Category testCategory = categoryList.get(categoryList.size() - 1);
        assertThat(testCategory.getImages()).isEqualTo(UPDATED_IMAGES);
        assertThat(testCategory.getImagesContentType()).isEqualTo(UPDATED_IMAGES_CONTENT_TYPE);

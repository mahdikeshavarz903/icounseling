...
public class UserResourceIT {
    ...
    private static final String UPDATED_LOGIN = "09307301162";
    ...
    public void createUserWithExistingEmail() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setLogin("09307301160");
        managedUserVM.setPassword(DEFAULT_PASSWORD);
        managedUserVM.setFirstName(DEFAULT_FIRSTNAME);
        managedUserVM.setLastName(DEFAULT_LASTNAME);
    ...
    public void updateUserExistingEmail() throws Exception {
        ...
        anotherUser.setLogin("09307301160");
    ...
    public void updateUserExistingLogin() throws Exception {
        ...
        ManagedUserVM managedUserVM = new ManagedUserVM();
        managedUserVM.setId(updatedUser.getId());
        managedUserVM.setLogin("09307301160");// this login should already be used by anotherUser
        managedUserVM.setPassword(updatedUser.getPassword());
        managedUserVM.setFirstName(updatedUser.getFirstName());
        managedUserVM.setLastName(updatedUser.getLastName());

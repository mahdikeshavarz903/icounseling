          ...
          <Table responsive>
            ...
            <tr>
              ...
              <th className="hand" onClick={this.sort('repeatTime')}>
                <Translate contentKey="iCounselingApp.task.repeatTime">Repeat Time</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th className="hand" onClick={this.sort('repeatUntil')}>
                <Translate contentKey="iCounselingApp.task.repeatUntil">Repeat Until</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th>

          ...
          <Table responsive>
            ...
            <tr>
              ...
              <th className="hand" onClick={this.sort('minSalary')}>
                <Translate contentKey="iCounselingApp.job.minSalary">Min Salary</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th className="hand" onClick={this.sort('maxSalary')}>
                <Translate contentKey="iCounselingApp.job.maxSalary">Max Salary</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th>

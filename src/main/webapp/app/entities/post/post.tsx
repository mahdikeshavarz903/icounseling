          ...
          <Table responsive>
            ...
            <tr>
              ...
              <th className="hand" onClick={this.sort('documentFormat')}>
                <Translate contentKey="iCounselingApp.post.documentFormat">Document Format</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th>
              ...
              <th>
                <Translate contentKey="iCounselingApp.post.counselor">Counselor</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th/>
            </tr>

            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('creationTime')}>
                  <Translate contentKey="iCounselingApp.library.creationTime">Creation Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.library.visitor">Visitor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>

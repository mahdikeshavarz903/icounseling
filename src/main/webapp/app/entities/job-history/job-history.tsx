          ...
          <Table responsive>
            ...
            <tr>
              ...
              <th className="hand" onClick={this.sort('startDate')}>
                <Translate contentKey="iCounselingApp.jobHistory.startDate">Start Date</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th className="hand" onClick={this.sort('endDate')}>
                <Translate contentKey="iCounselingApp.jobHistory.endDate">End Date</Translate> <FontAwesomeIcon
                icon="sort"/>
              </th>
              <th>

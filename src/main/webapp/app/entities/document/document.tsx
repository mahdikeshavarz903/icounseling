            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="iCounselingApp.document.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={this.sort('publishedDate')}>
                  <Translate contentKey="iCounselingApp.document.publishedDate">Published Date</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('paymentType')}>
                  <Translate contentKey="iCounselingApp.document.paymentType">Payment Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('documentFormat')}>
                  <Translate contentKey="iCounselingApp.document.documentFormat">Document Format</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('imagesGallery')}>
                  <Translate contentKey="iCounselingApp.document.imagesGallery">Images Gallery</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="iCounselingApp.document.comment">Comment</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.document.gategory">Gategory</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.document.counselor">Counselor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {documentList.map((document, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{document.commentId ? <Link to={`comment/${document.commentId}`}>{document.commentId}</Link> : ''}</td>
                  <td>
                  ...
                  <td>{document.counselorId ? <Link to={`counselor/${document.counselorId}`}>{document.counselorId}</Link> : ''}</td>

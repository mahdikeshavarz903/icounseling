            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('startDateTime')}>
                  <Translate contentKey="iCounselingApp.planning.startDateTime">Start Date Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('endDateTime')}>
                  <Translate contentKey="iCounselingApp.planning.endDateTime">End Date Time</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="iCounselingApp.planning.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.planning.counselor">Counselor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {planningList.map((planning, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{planning.counselorId ? <Link to={`counselor/${planning.counselorId}`}>{planning.counselorId}</Link> : ''}</td>

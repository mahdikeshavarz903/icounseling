      ...
      <div>
        <h2 id="counseling-case-heading">
          ...
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            ...
            &nbsp;
            <Translate contentKey="iCounselingApp.counselingCase.home.createLabel">Create new Counseling Case</Translate>
          </Link>
        </h2>
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="iCounselingApp.counselingCase.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.counselingCase.visitor">Visitor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.counselingCase.counselor">Counselor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {counselingCaseList.map((counselingCase, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {counselingCase.visitorId ? <Link to={`visitor/${counselingCase.visitorId}`}>{counselingCase.visitorId}</Link> : ''}
                  </td>
                  <td>

...
import {createEntity, getEntity, reset, setBlob, updateEntity} from './category.reducer';
        ...
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="iCounselingApp.category.home.createOrEditLabel">
              <Translate contentKey="iCounselingApp.category.home.createOrEditLabel">Create or edit a
                Category</Translate>
            </h2>
          </Col>
        </Row>

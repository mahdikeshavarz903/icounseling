            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('totalAmount')}>
                  <Translate contentKey="iCounselingApp.transaction.totalAmount">Total Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('status')}>
                  <Translate contentKey="iCounselingApp.transaction.status">Status</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="iCounselingApp.transaction.visitor">Visitor</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {transactionList.map((transaction, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{transaction.visitorId ? <Link to={`visitor/${transaction.visitorId}`}>{transaction.visitorId}</Link> : ''}</td>

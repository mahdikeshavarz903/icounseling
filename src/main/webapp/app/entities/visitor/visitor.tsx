          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="iCounselingApp.visitor.education">Education</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {visitorList.map((visitor, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>{visitor.educationId ? <Link to={`education/${visitor.educationId}`}>{visitor.educationId}</Link> : ''}</td>

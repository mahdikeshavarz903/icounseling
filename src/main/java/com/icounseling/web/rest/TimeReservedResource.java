...
public class TimeReservedResource {
    ...
    public ResponseEntity<List<TimeReservedDTO>> getAllTimeReserveds(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {

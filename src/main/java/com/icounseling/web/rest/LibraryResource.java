...
/**
 * REST controller for managing {@link com.icounseling.domain.Library}.
 */
@RestController
@RequestMapping("/api")
public class LibraryResource {
    ...
    public ResponseEntity<List<LibraryDTO>> getAllLibraries(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
